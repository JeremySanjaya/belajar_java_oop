package progammer.zaman.now.util;

import progammer.zaman.now.annotation.NotBlank;
import progammer.zaman.now.data.LoginRequest;
import progammer.zaman.now.error.BlankException;
...
public class ValidationUtil {
    ...
    public static void validateRuntime(LoginRequest loginRequest) throws ValidationException, NullPointerException {
        if (loginRequest.username() == null) {
            throw new NullPointerException("Username tidak boleh null");
        } else if (loginRequest.username().isBlank()) {
